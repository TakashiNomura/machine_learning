...
class NeuralNetwork:
    ...
    def learn(self,input_data):
        ...
        # 出力層→中間層
        p = (correct_value - output_data) * output_data * (1.0 - output_data)
...
for data in data_to_commit:
    if neural_network.commit(data) < 0.5:
        position_tokyo_learned[0].append(data[1]+refer_point1)
        position_tokyo_learned[1].append(data[0] + refer_point0)
    else:
        position_kanagawa_learned[0].append(data[1]+refer_point1)
        position_kanagawa_learned[1].append(data[0] + refer_point0)
